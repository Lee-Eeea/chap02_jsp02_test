...
%>
	...
	<!-- 
		...
		3. id가 member인 객체가 없으면 톰캣이 member 객체를 생성해서 제공해준다. 
	 -->
...
<% 
	...
	// request.setAttribute("저장할이름", 저장할객체);
