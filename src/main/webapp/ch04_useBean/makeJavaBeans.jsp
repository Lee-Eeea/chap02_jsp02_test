<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <!-- 
   	...
   	- 객체로 생성한 자바 빈즈는 request, session, application 영역(scope)에 저장하여
   	  다른 페이지들과 공유할 수 있다.
   	- id="member" : 자바빈즈를 만드는데 그 이름을 member라고 하겠다.
   	- class="자바빈즈로 만들어질 도메인클래스의 풀경로" 
...
%>
	<!-- 링크로 이동하는게 아니라 forward로 이동하기 때문에 request가 전달된다. -->
